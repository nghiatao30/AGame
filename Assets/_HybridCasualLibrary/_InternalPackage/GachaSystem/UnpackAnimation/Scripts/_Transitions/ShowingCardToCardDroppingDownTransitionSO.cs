...
namespace LatteGames.UnpackAnimation
{
    ...
    [CreateAssetMenu(fileName = "ShowingCard - CardDroppingDownTransitionSO", menuName = "LatteGames/ScriptableObject/GachaSystem/TransitionSO/ShowingCardToCardDroppingDownTransitionSO")]
    public class ShowingCardToCardDroppingDownTransitionSO : ShowingCardToSummaryTransitionSO
    {
