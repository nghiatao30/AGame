...
namespace I2.Loc
{
	public partial class LocalizationEditor
	{
		...
		public static void Import_Global_CSV(LanguageSourceAsset sourceAsset, string FileName, eSpreadsheetUpdateMode UpdateMode)
		{
			LanguageSourceData source = sourceAsset.SourceData;
